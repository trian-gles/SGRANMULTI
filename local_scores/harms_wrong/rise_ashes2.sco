...
ratelo = 0.00004
ratemid =0.0008 // maketable("line", "nonorm", 200, 0, 0.08, 1, 0.008)
ratehi = 0.004 // maketable("line", "nonorm", 200, 0, 0.4, 1, 0.04)
...
freqlo = maketable("line", "nonorm", 200, 0, cpspch(6.00), 5, cpspch(6.00) , 5.5, 200, 6, 255, 9, 255, 9.5, 200, 10, cpspch(6.00))
freqmid = maketable("line", "nonorm", 200, 0, cpspch(6.00), 5, cpspch(6.00) , 6, 260, 9, 260, 9.5, 260, 10, cpspch(6.00))
freqhi = maketable("line", "nonorm", 200, 0, cpspch(6.00), 5, cpspch(6.00), 5.5, 800, 6, 265, 9, 265, 9.5, 800, 10, cpspch(6.00))
...
for (i = 0; i < harms; i = i + 1){
    ...
    SGRAN2MULTI(inskip, dur, 4000 * amp, ratelo * i, ratemid * i, ratehi* i, rateti, durlo * i, durmid * i, durhi * i, durti, 
