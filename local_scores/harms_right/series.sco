...
freqlo = 400 / 2// maketable("line", "nonorm", 200, 0, 400, 1, 200)
freqmid = 430 / 2//maketable("line", "nonorm", 200, 0, 430, 1, 350, 2, 600)
freqhi = 440 / 2//maketable("line", "nonorm", 200, 0, 440, 1, 460, 2, 800)
...
for (i = 0; i < harms; i = i + 1){
    ...
    ampbase = maketable("wave3", 1000, 1, 1, phase) + 1
	amp = mul(mul(ampbase, ampbase), ampbase) / 8

    start_angle = randrange(360, 720)
    dist_travel = randrange(-360, 360)
    angle = maketable("line", "nonorm", 1000, 0,start_angle, 4, start_angle, 5, start_angle + dist_travel, 9, start_angle + dist_travel)
