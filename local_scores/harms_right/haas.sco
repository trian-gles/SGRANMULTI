...
inskip2 = dur_harms - dur_gap
freq2 = 383
freqlo2 = 380 / 3// maketable("line", "nonorm", 200, 0, 400, 1, 200)
freqmid2 = 383 / 3//maketable("line", "nonorm", 200, 0, 430, 1, 350, 2, 600)
freqhi2 = 386 / 3//maketable("line", "nonorm", 200, 0, 440, 1, 460, 2, 800)
freqti2 = 6 // maketable("line", "nonorm", 200, 0, 6, 1, 0.2)
...
for (i = 0; i < harms; i = i + 1){
    ...
    angle = maketable("line", "nonorm", 1000, 0,start_angle, 1, start_angle + dist_travel)
    radius = 0.7 // maketable("line", "nonorm", 1000, 0,0, 1,6)
    SGRAN2MULTI(inskip2, dur, 800 * amp * mast_amp, ratelo, ratemid, ratehi, rateti, durlo, durmid, durhi, durti, 
    freqlo2 * mult, freqmid2 * mult, freqhi2 * mult, freqti, angle, distance, radius, wave, env, "polar")
}
