...
for (h = 0; h < 20; h = h + 1)
{
	...
	for (i = 0; i < harms; i = i + 1){
		...
		durlo = irand(0.0004, 0.0012) // maketable("line", "nonorm", 200, 0, log(trand(2, 10)) / trand(20, 90), 1, log(trand(2, 10)) / trand(20, 90))
		...
		mult = i + 1
		phase = irand(0, 1)
		amp_cycles = irand(4, 8)
		amp_duty = irand(0.2, 0.3)
		lag = 0.4
		...
		SGRAN2MULTI(st, dur, 20 * amp * mast_amp, ratelo, ratemid, ratehi, rateti, durlo, durmid, durhi, durti, 
