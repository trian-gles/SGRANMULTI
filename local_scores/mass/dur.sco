...
durlo = maketable("line", "nonorm", 200, 0, 0.003, 1, 0.0003, 2, 0.003)
durmid = maketable("line", "nonorm", 200, 0, 0.03, 1, 0.003, 2, 0.03)
durhi = maketable("line", "nonorm", 200, 0, 0.3, 1, 0.03, 2, 0.3)
durti = 3
...
squarewave = maketable("wave", 1000, "saw")
...
freqlo, freqmid, freqhi, freqti, angle, distance, radius, squarewave, env, "polar")
